...
const RangeSlider = ({ minValue, maxValue, onMinChange, onMaxChange, min = 0, max = 100 }) => {
	...
	return (
		<div className="range-slider-wrapper">
			<div className="range-slider-labels">
				<span className="range-label-min">€{minValue}</span>
				<span className="range-label-max">€{maxValue}</span>
			</div>
