            ...
            <div className="footer-container">
                <div className="footer-col">
                    ...
                    <p className="footer-text">
                        Conserva ciò che conta davvero. Le nostre capsule del tempo sono progettate
                        per preservare i tuoi ricordi più preziosi per le generazioni future.
                    </p>
                ...
                <div className="footer-col">
                    ...
                    <ul className="footer-list">
                        ...
                        <li><Link to="/shipping">Spedizioni</Link></li>
                        <li><Link to="/returns">Resi</Link></li>
                        <li><Link to="/warranty">Garanzia</Link></li>
                    </ul>
                </div>
            </div>
